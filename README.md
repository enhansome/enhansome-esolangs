...
* [JSFuck](https://github.com/aemkei/jsfuck) ⭐ 8,596 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10 - Esoteric programming style based on the atomic parts of JavaScript.
...
* [Enterprise™](https://github.com/joaomilho/Enterprise) ⭐ 1,619 | 🐛 35 | 🌐 JavaScript | 📅 2023-05-08 - Non deterministic unnecessarily statically typed language.
...
* [Monicelli](https://github.com/esseks/monicelli) ⭐ 1,380 | 🐛 21 | 🌐 C++ | 📅 2025-11-23 - Programming using Italian-like gibberish.
...
* [Watson](https://github.com/genkami/watson) ⭐ 269 | 🐛 9 | 🌐 Go | 📅 2026-08-29 - Stack-based Turing-incomplete configuration files.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,675 | 🐛 4,721 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,794 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
...
* [MalbolgeLisp](https://github.com/kspalaiologos/malbolge-lisp) ⭐ 553 | 🐛 0 | 🌐 TeX | 📅 2025-08-05 - A Lisp interpreter in Malbolge Unshackled.
