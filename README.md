...
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,038 | 🐛 26 | 🌐 Python | 📅 2022-09-26 - Only Vigil is truly vigilant about not allowing code that fails to pass programmatic specifications.
...
* [FlipJump](https://github.com/tomhea/flip-jump) ⭐ 142 | 🐛 7 | 🌐 Text | 📅 2026-09-07 - 1 instruction: Flip a bit, then Jump. The simplest OISC.
...
* [NoCode](https://github.com/kelseyhightower/nocode) ⭐ 65,706 | 🐛 4,720 | 🌐 Dockerfile | 📅 2024-08-07 - Secure and reliable applications. Write nothing; deploy nowhere.
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,843 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - Simple FizzBuzz game implemented under the most strict enterprise standards.
